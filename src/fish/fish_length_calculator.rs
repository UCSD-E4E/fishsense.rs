...
impl FishLengthCalculator {
    ...
    fn get_depths(&self, depth_mask: &Array2<f32>, left_img_coord: &Array1<f32>, right_img_coord: &Array1<f32>) -> (f32, f32) {
        ...
        println!("RUST: {} left depth: {}, step depth: {}", left_step, depth_mask[[left_coord[0], left_coord[1]]], depth_mask[[left_step[0], left_step[1]]]);
        println!("RUST: {} right depth: {}, step depth: {}", right_step, depth_mask[[right_coord[0], right_coord[1]]], depth_mask[[right_step[0], right_step[1]]]);
